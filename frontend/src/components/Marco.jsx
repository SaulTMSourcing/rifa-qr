      ...
      >
        ...
        <header className="flex shrink-0 items-center gap-3 px-5 pb-3 pt-5">
          ...
          <div className="ml-auto flex shrink-0 items-center gap-2">
            {/*
              Los premios se pueden consultar en cualquier momento del
              recorrido: son el motivo por el que alguien decide
              contestar, y esconderlos hasta el final desperdicia ese
              gancho. Va en acento porque es la accion opcional que si
              queremos que se toque.
            */}
            {onVerPremios && (
              <button
                type="button"
